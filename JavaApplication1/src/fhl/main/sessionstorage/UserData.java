...
public class UserData {
    ...
    public UserData(String username, int companyUnit, String currency, String group, boolean ibAccount, double leverageMultiplier, String spreadType) {
    ...
    {
        return "Username: "+this.username + " \nCompanyUnit: " +Integer.toString(this.companyUnit)+
