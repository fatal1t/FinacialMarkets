...
public class SymbolData {
    ...
    private final int swapType;
    private final int swapRollover;
    ...
    public SymbolData(double ask, double bid, String currency, String currencyProfit, String description, 
            ...
            Long marginMaintenance, int marginMode, double percentage, int profitMode, double spreadRaw, 
            double spreadTable, boolean swapEnable, double swapLong, double swapShort, int swapType, 
            int swapRollover, double tickSize, double tickValue, int quoteId, String timeString, 
            double leverage, boolean currencyPair) {
        this.ask = ask;
        this.bid = bid;
