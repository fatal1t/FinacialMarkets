...
import org.fatal1t.backend.forexbackend.services.CandlePostProcessService;
 ...
 */
@Component
public class M5RealTimeListener implements  UpdateListener{
    @Autowired
    private CandlePostProcessService candleService;
