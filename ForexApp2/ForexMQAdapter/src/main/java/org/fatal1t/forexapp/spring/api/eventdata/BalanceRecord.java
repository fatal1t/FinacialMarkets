...
public class BalanceRecord extends BaseRecord {
    ...
    public BalanceRecord(SBalanceRecord record)
    {
        this(record.getBalance(), record.getMargin(), record.getEquity(), record.getMarginLevel(), record.getMarginFree(), record.getCredit());        
    }
